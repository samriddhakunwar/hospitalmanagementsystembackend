...
SECRET_KEY = 'django-insecure-k9rb9mths3jrm67i&0qoaxm+jcn_zfv!v=f7huqd7-^ul(roli'
...
EMAIL_HOST = 'sandbox.smtp.mailtrap.io'  # or your SMTP server
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'da07703c1a803b'
EMAIL_HOST_PASSWORD = '21f6be0834ff65'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=1200),  # Adjust as needed
    ...
    'USER_ID_FIELD': 'id',  # Customize if necessary
